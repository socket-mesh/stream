// There seems to be a bug when you execute a typescript test directly.
...
import { WritableConsumableStream } from'../dist/index';
...
describe('WritableConsumableStream', () => {
  ...
  describe('backpressure', () => {
    ...
    it('should reset backpressure after invoking consumer.return()', async () => {
      ...
      assert.equal(stream.getConsumerStats().length, 0);
      assert.equal(consumer.getBackpressure(), 0);
